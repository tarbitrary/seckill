...
//    "value" : "<html><body><b>Data Source:</b> seckill@localhost<br><b>Schema:</b> seckill<br><b>Table:</b> order_info<br><br><code><pre><font color=\"#808080\">-- auto-generated definition</font>\n<font color=\"#cc7832\">create</font> <font color=\"#cc7832\">table</font> order_info\n(\n    id               <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">auto_increment</font>\n        <font color=\"#cc7832\">primary</font> <font color=\"#cc7832\">key</font><font color=\"#cc7832\">,</font>\n    user_id          <font color=\"#cc7832\">bigint</font>                      <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;用户ID&#39;</font><font color=\"#cc7832\">,</font>\n    goods_id         <font color=\"#cc7832\">bigint</font>                      <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;商品ID&#39;</font><font color=\"#cc7832\">,</font>\n    delivery_addr_id <font color=\"#cc7832\">bigint</font>                      <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;收获地址ID&#39;</font><font color=\"#cc7832\">,</font>\n    goods_name       <font color=\"#cc7832\">varchar</font>(<font color=\"#6897bb\">16</font>)                 <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;冗余过来的商品名称&#39;</font><font color=\"#cc7832\">,</font>\n    goods_count      <font color=\"#cc7832\">int</font>            <font color=\"#cc7832\">default</font> <font color=\"#6897bb\">0</font>    <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;商品数量&#39;</font><font color=\"#cc7832\">,</font>\n    goods_price      <font color=\"#cc7832\">decimal</font>(<font color=\"#6897bb\">10</font><font color=\"#cc7832\">,</font> <font color=\"#6897bb\">2</font>) <font color=\"#cc7832\">default</font> <font color=\"#6897bb\">0.00</font> <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;商品单价&#39;</font><font color=\"#cc7832\">,</font>\n    order_channel    <font color=\"#cc7832\">tinyint</font>        <font color=\"#cc7832\">default</font> <font color=\"#6897bb\">0</font>    <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;1pc，2android，3ios&#39;</font><font color=\"#cc7832\">,</font>\n    <font color=\"#cc7832\">status</font>           <font color=\"#cc7832\">tinyint</font>        <font color=\"#cc7832\">default</font> <font color=\"#6897bb\">0</font>    <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;订单状态，0新建未支付，1已支付，2已发货，3已收货，4已退款，5已完成&#39;</font><font color=\"#cc7832\">,</font>\n    create_date      <font color=\"#cc7832\">datetime</font>                    <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;订单的创建时间&#39;</font><font color=\"#cc7832\">,</font>\n    pay_date         <font color=\"#cc7832\">datetime</font>                    <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;支付时间&#39;</font>\n)\n    <font color=\"#cc7832\">charset</font> = utf8mb4<font color=\"#cc7832\">;</font></pre></code>"
//  }, {
//    "name" : "getDocumentation",
...
//    "value" : "DB VirtualFile: table, seckill.order_info [seckill@localhost] (Valid)"
//  }, {
...
//    "value" : "Deferred. Base=Row icon. myIcons=[jar:file:/usr/local/software/idea-IU-193.5233.102/plugins/DatabaseTools/lib/database-openapi.jar!/icons/table.svg, null]"
//  }, {
//    "name" : "getWeight",
...
//    "value" : "[Lcom.intellij.psi.PsiReference;@2c7c89cc"
//  }, {
...
//    "value" : "{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@1259c6ec, lastComputedIcon={0=Row icon. myIcons=[jar:file:/usr/local/software/idea-IU-193.5233.102/plugins/DatabaseTools/lib/database-openapi.jar!/icons/table.svg, null]}, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@1e4663b7}"
//  }, {
//    "name" : "copyUserDataTo",
...
//    "value" : "[Ljava.lang.Object;@3b3d065b"
//  }, {
//    "name" : "getDependences",
...
//    "value" : "com.intellij.idea.IdeaLogger@1c05574c"
//  }, {
//    "name" : "WEIGHT_BASE",
//    "type" : "int",
//    "value" : "10000"
...
//    "name" : "LOG",
//    "type" : "com.intellij.openapi.diagnostic.Logger",
//    "value" : "com.intellij.idea.IdeaLogger@5460829"
//  }, {
//    "name" : "LOG",
//    "type" : "com.intellij.openapi.diagnostic.Logger",
//    "value" : "com.intellij.idea.IdeaLogger@2ef13c55"
//  }, {
//    "name" : "FLAGS_LOCKED",
//    "type" : "int",
//    "value" : "2048"
...
//    "value" : "com.intellij.psi.impl.ElementBase$$Lambda$1509/0x0000000101795040@1878b1f0"
//  }, {
//    "name" : "VISIBILITY_ICON_PLACEHOLDER",
//    "type" : "com.intellij.openapi.util.NotNullLazyValue",
//    "value" : "com.intellij.psi.impl.ElementBase$1@37e48d40"
//  }, {
//    "name" : "ICON_PLACEHOLDER",
//    "type" : "com.intellij.openapi.util.NotNullLazyValue",
//    "value" : "com.intellij.psi.impl.ElementBase$2@2d6dcd5"
//  }, {
...
//    "value" : "com.intellij.util.concurrency.AtomicFieldUpdater@25624b4e"
//  } ]
//}
//
////调试列原始对象
...
//    "value" : "<html><body><b>Data Source:</b> seckill@localhost<br><b>Schema:</b> seckill<br><b>Table:</b> order_info<br><b>Column:</b> id<br><br><code><pre><font color=\"#cc7832\">alter</font> <font color=\"#cc7832\">table</font> order_info\n    <font color=\"#cc7832\">add</font> id <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">auto_increment</font><font color=\"#cc7832\">;</font>\n\n</pre></code>"
//  }, {
//    "name" : "getDocumentation",
...
//    "name" : "getVirtualFile",
//    "desc" : "public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
//    "value" : "DB VirtualFile: column, seckill.order_info.id [seckill@localhost] (Valid)"
//  }, {
//    "name" : "processChildren",
//    "desc" : "public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<com.intellij.psi.PsiFileSystemItem>)",
//    "value" : null
...
//    "name" : "getLocationString",
//    "desc" : "public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
//    "value" : "seckill.order_info [seckill@localhost]"
//  }, {
//    "name" : "getDataSource",
//    "desc" : "public com.intellij.database.psi.DbDataSource com.intellij.database.psi.DbElementImpl.getDataSource()",
//    "value" : "root:seckill@localhost"
...
//    "name" : "getUserDataString",
//    "desc" : "public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
//    "value" : "{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@67143a93, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@473dff28}"
//  }, {
//    "name" : "copyUserDataTo",
//    "desc" : "public void com.intellij.openapi.util.UserDataHolderBase.copyUserDataTo(com.intellij.openapi.util.UserDataHolderBase)",
//    "value" : null
...
//    "value" : "com.intellij.database.model.LengthUnit@2beb0681"
//  }, {
//    "name" : "vagueArg",
//    "type" : "java.lang.String",
//    "value" : null
