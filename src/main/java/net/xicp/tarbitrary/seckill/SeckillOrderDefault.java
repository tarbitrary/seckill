...
//    "value" : "<html><body><b>Data Source:</b> seckill@localhost<br><b>Schema:</b> seckill<br><b>Table:</b> seckill_order<br><br><code><pre><font color=\"#808080\">-- auto-generated definition</font>\n<font color=\"#cc7832\">create</font> <font color=\"#cc7832\">table</font> seckill_order\n(\n    id       <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">auto_increment</font>\n        <font color=\"#cc7832\">primary</font> <font color=\"#cc7832\">key</font><font color=\"#cc7832\">,</font>\n    user_id  <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;用户ID&#39;</font><font color=\"#cc7832\">,</font>\n    order_id <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;订单ID&#39;</font><font color=\"#cc7832\">,</font>\n    goods_id <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">null</font> <font color=\"#cc7832\">comment</font> <font color=\"#6a8759\">&#39;商品ID&#39;</font>\n)\n    <font color=\"#cc7832\">charset</font> = utf8mb4<font color=\"#cc7832\">;</font></pre></code>"
//  }, {
//    "name" : "getDocumentation",
...
//    "value" : "DB VirtualFile: table, seckill.seckill_order [seckill@localhost] (Valid)"
//  }, {
...
//    "value" : "{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@78f775d4, lastComputedIcon={0=Row icon. myIcons=[jar:file:/usr/local/software/idea-IU-193.5233.102/plugins/DatabaseTools/lib/database-openapi.jar!/icons/table.svg, null]}, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@69464ee6}"
//  }, {
//    "name" : "copyUserDataTo",
...
//    "value" : "<html><body><b>Data Source:</b> seckill@localhost<br><b>Schema:</b> seckill<br><b>Table:</b> seckill_order<br><b>Column:</b> id<br><br><code><pre><font color=\"#cc7832\">alter</font> <font color=\"#cc7832\">table</font> seckill_order\n    <font color=\"#cc7832\">add</font> id <font color=\"#cc7832\">bigint</font> <font color=\"#cc7832\">auto_increment</font><font color=\"#cc7832\">;</font>\n\n</pre></code>"
//  }, {
//    "name" : "getDocumentation",
...
//    "name" : "getVirtualFile",
//    "desc" : "public com.intellij.openapi.vfs.VirtualFile com.intellij.database.psi.DbElementImpl.getVirtualFile()",
//    "value" : "DB VirtualFile: column, seckill.seckill_order.id [seckill@localhost] (Valid)"
//  }, {
//    "name" : "processChildren",
//    "desc" : "public boolean com.intellij.database.psi.DbElementImpl.processChildren(com.intellij.psi.search.PsiElementProcessor<com.intellij.psi.PsiFileSystemItem>)",
//    "value" : null
...
//    "name" : "getLocationString",
//    "desc" : "public java.lang.String com.intellij.database.psi.DbElementImpl.getLocationString()",
//    "value" : "seckill.seckill_order [seckill@localhost]"
//  }, {
//    "name" : "getDataSource",
//    "desc" : "public com.intellij.database.psi.DbDataSource com.intellij.database.psi.DbElementImpl.getDataSource()",
//    "value" : "root:seckill@localhost"
...
//    "name" : "getText",
//    "desc" : "public java.lang.String com.intellij.database.psi.DbElementImpl.getText()",
//    "value" : "alter table seckill_order\n    add id bigint auto_increment;\n\n"
//  }, {
//    "name" : "newDeclarationProcessor",
//    "desc" : "public static com.intellij.util.Processor<com.intellij.database.psi.DbElement> com.intellij.database.psi.DbElementImpl.newDeclarationProcessor(com.intellij.psi.scope.PsiScopeProcessor,com.intellij.psi.ResolveState,com.intellij.psi.PsiElement)",
//    "value" : null
...
//    "name" : "getUserDataString",
//    "desc" : "public java.lang.String com.intellij.openapi.util.UserDataHolderBase.getUserDataString()",
//    "value" : "{COLOR_KEY=com.intellij.database.view.DatabaseColorManager$CachedColor@5ef223fc, CACHED_SMART_POINTER_KEY=com.intellij.reference.SoftReference@c79f4b5}"
//  }, {
//    "name" : "copyUserDataTo",
//    "desc" : "public void com.intellij.openapi.util.UserDataHolderBase.copyUserDataTo(com.intellij.openapi.util.UserDataHolderBase)",
//    "value" : null
